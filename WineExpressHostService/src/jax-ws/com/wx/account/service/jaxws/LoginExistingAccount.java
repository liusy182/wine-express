...
@XmlRootElement(name = "loginExistingAccount", namespace = "http://service.account.wx.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "loginExistingAccount", namespace = "http://service.account.wx.com/")
public class LoginExistingAccount {
